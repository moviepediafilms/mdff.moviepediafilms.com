    ...
    data: {
        steps: [
            ...
            },
            {
                ...
                date: "June 26th",
                activate_on: moment.tz('Jun 27 2020', "MMM DD YYYY", "Asia/Kolkata")
            },
            {
                id: 3,
            ...
            },
            {
                ...
                date: "July 1st",
                activate_on: moment.tz('Jul 01 2020', "MMM DD YYYY", "Asia/Kolkata")
            },
            {
                id: 5,
                ...
                date: "July 10th",
                activate_on: moment.tz('Jul 11 2020', "MMM DD YYYY", "Asia/Kolkata")
            },
            {
                id: 6,
            ...
            },
            {
                ...
                date: "August 2nd",
                activate_on: moment.tz('Aug 02 2020', "MMM DD YYYY", "Asia/Kolkata")
            }]
    },
    mounted() {
        $('.stepper').mdbStepper();
